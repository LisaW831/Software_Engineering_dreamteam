...
/** Class defined to create the report to query: All the capital cities in a continent organised by largest population to smallest. */
public class Report_18 {
    ...
    // Method to display capital cities of a continent
    public static void displayCapitalsOfContinent(Connection con, String continent) {
        try {
            ...
            System.out.println("Capital cities in " + continent + " ordered by population (highest to lowest):");
            while (resultSet.next()) {
