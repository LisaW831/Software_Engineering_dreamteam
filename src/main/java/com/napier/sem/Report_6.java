...
public class Report_6 {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Enter the number of populated countries in a region to display: ");
        ...
        Report_6.retrieveCountriesByRegionPopulation(con, regionName, numberOfCountries); // Calls a method to retrieve countries by region population
    }
    ...
    // Method to retrieve countries sorted by population by region
    public static void retrieveCountriesByRegionPopulation(Connection con, String regionName, int numberOfCountries) {
        try {
            String sql = "SELECT c.Name AS CountryName, c.Population, co.Name AS RegionName " +
                    "FROM city c " +
            ...
            if (!resultSet.isBeforeFirst()) {
                ...
                System.out.println("Top " + numberOfCountries + " populated cities in " + regionName + ":"); // Indicates the start of the output
